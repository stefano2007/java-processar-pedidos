...
public class ClienteController {
    ...
    @GetMapping("/api/clientes/resumo-pedidos")
    public ResponseEntity<List<ClienteResumoPedidoResponse>> obterClienteResumoPedidos() {
        return ResponseEntity.ok(pedidoService.obterClienteResumoPedidos());
    }
}
